...
LOAD DATA LOCAL INFILE '/Users/zhou/Downloads/MarketIndex-small.txt' INTO TABLE MarketIndex
FIELDS TERMINATED BY ','
LINES TERMINATED BY '\r\n'
IGNORE 1 LINES
(ticker, date_, openPrice, high, low, closePrice, volume);

LOAD DATA LOCAL INFILE '/Users/zhou/Downloads/Bond-small.txt' INTO TABLE Bond
FIELDS TERMINATED BY ','
LINES TERMINATED BY '\r\n'
IGNORE 1 LINES
(ticker, date_, price, openPrice, high, low, changePercent);

LOAD DATA LOCAL INFILE '/Users/zhou/Downloads/SectorETF-small.txt' INTO TABLE SectorETF
FIELDS TERMINATED BY ','
LINES TERMINATED BY '\r\n'
IGNORE 1 LINES
(ticker, date_, openPrice, high, low, closePrice, volume);

LOAD DATA LOCAL INFILE '/Users/zhou/Downloads/OptionVolume-small.txt' INTO TABLE OptionVolume
FIELDS TERMINATED BY ','
LINES TERMINATED BY '\r\n'
IGNORE 1 LINES
(ticker, date_, callVol, putVol, putCallRatio);

LOAD DATA LOCAL INFILE '/Users/zhou/Downloads/Company-small.txt' INTO TABLE Company
FIELDS TERMINATED BY ','
LINES TERMINATED BY '\r\n'
IGNORE 1 LINES
