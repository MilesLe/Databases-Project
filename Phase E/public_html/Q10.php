...
echo "<h2>Q10: Over all weeks between ".$weekDateStart." and ".$weekDateEnd." where ".$inputTicker." bond is red, for each sector how many of those weeks had an average put/call ratio above ".$ratio."?</h2>";

$dataPoints = array();

//Determine if any input was actually collected
if (empty($inputTicker) or empty($ratio) or empty($weekDateStart) or empty($weekDateEnd)) {
   ...
   if ($stmt = $conn->prepare("CALL Q10(?, ?, ?, ?)")) {
      $stmt->bind_param("sdss", $inputTicker, $ratio, $weekDateStart, $weekDateEnd);
      ...
      if ($stmt->execute()) {
         ...
         if ($weekDateStart > $weekDateEnd) {
            ...
            echo "<tr><th> Ticker </th><th> Num Weeks </th><th> Average put-call-ratio </th></tr>";
