...
//Collect the posted value in a variable called $weekDate
$weekDate = $_POST['weekDate'];

echo "<h2>Q1: In the week of ".$weekDate.", which sector performed the best? What was the price at the end of week and the average volume?</h2>";

//Determine if any input was actually collected
if (empty($weekDate)) {

   echo "No input collected.<br><br>";

} else {

   //Prepare a statement that we can later execute. The ?'s are placeholders for
   //parameters whose values we will set before we run the query.
   if ($stmt = $conn->prepare("CALL Q1(?)")) {
      ...
      if ($stmt->execute()) {
         ...
         if ($result->num_rows == 0) {
            ...
            echo "Sector results not found for this date.";

         } else {
	 
            //Create table to display results
            echo "<table border=\"1px solid black\">";
            echo "<tr><th> Sector </th> <th> Average Volume </th> <th> End Price </th></tr>";
